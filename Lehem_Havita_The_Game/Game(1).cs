...
namespace Lehem_Havita_The_Game
{
    public partial class Game : Form
    {
        ...
        {
            this.Location = new System.Drawing.Point(340, 160);
        ...
        public void Game_is_over()
        {
            ...
            GO_Form.ShowDialog();
            Score_Window_Ref.add_new_score(current_Player.Name + diff_name,current_Player.Score,current_order.Order_count);
            this.Close();
        }
